function Disable-DbsUserOptions {
    <#
    .SYNOPSIS
        Disables non-compliant User Options settings
    ...
    .NOTES
        Tags: V-79335, NonCompliantResults
    ...
    process {
        Set-DbaSpConfigure @PSBoundParameters -Name UserOptions -Value 0
    }
}