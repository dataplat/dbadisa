function Get-DbsReplicationXp {
    <#
    .SYNOPSIS
        Gets non-compliant Replication Xp settings.
    ...
    .NOTES
        Tags: V-79351, NonCompliantResults
    ...
    process {
        Get-DbaSpConfigure @PSBoundParameters -Name ReplicationXPsEnabled | Where-Object RunningValue -eq 1
    }
}